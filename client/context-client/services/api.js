...
const baseUrl = 'http://physeter-context-server-gateway-569507109.us-west-2.elb.amazonaws.com';
...
export function fetchRecommends({ lat, lng, datetime, fuel, passenger }) {
  ...
  return fetch(baseUrl + path + '?' + params.toString(), { mode: 'cors' }).then((res) => res.json());
}
